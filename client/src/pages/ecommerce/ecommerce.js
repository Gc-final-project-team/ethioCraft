...
<div class=" bg-gray-50 text-gray-800">
  <div class="fixed top-0 left-0 w-fit bg-white dark:bg-slate-900 h-full ">
    ...
    <div class="overflow-y-auto overflow-x-hidden flex-grow">
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li class="px-5 pt-5">
          ...
          <p class="block  text-base antialiased font-serif font-bold leading-relaxed text-blue-gray-800 dark:text-white">
        Categories
        </p>
          </div>
        </li>

        <label htmlFor="vertical-list-svelte" class="flex items-center w-full px-3  cursor-pointer">
        ...
        <p class="block font-sans text-base antialiased font-serif font-light leading-relaxed text-blue-gray-900 dark:text-white">
        Crochet
        </p>
      </label>
      <label htmlFor="vertical-list-svelte" class="flex items-center w-full px-3  cursor-pointer">
      ...
      <li class="px-5">
          <div class="flex flex-row items-center h-10">
          <p class="block  text-base antialiased font-serif font-bold leading-relaxed text-blue-gray-800">
       Price
        </p>
          </div>
        </li>
...
<section className="bg-gray-50 dark:bg-gray-900 ml-36">

<div class="sm:w-1/2 p-5 mr-30">
        
        <h2 class="text-center my-4 font-bold text-3xl text-slate-800 dark:text-white sm:text-4xl ">Craft Ecommerse <span class="text-red-600 dark:text-yellow-400">Hub</span>
        </h2>
    ...
    <div class="my-8">
        ...
        {/* <div class="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:w-1/2"  style={{"background-image": "url('https://potterymakinginfo.com/wp-content/uploads/2015/03/making-pottery-on-the-wheel-480x430.jpg')"}}>
          
                <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                    <div class="px-10 max-w-xl">
                        <h2 class="text-2xl text-white font-semibold"> Traditional sefedes</h2>
            ...
            <div class="md:flex mt-8 md:-mx-4">
                <div class="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:w-1/2"  style={{"background-image": "url('https://i.pinimg.com/736x/d7/07/e1/d707e1682d4bda0701e85f11a5a491e5--handmade-crafts-ethiopia.jpg')"}}>
                    <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                        <div class="px-10 max-w-xl">
                            <h2 class="text-2xl text-white font-semibold opacity-">Traditional sefed</h2>
                            <p class="mt-2 text-gray-50">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore facere provident molestias ipsam sint voluptatum pariatur.</p>
                ...
                <div class="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:mt-0 md:w-1/2" style={{"background-image": "url('https://th.bing.com/th/id/R.2cc1bbbac5e86235960c9f6a0db60625?rik=xe6%2bFDx0T2vPVQ&riu=http%3a%2f%2fwww.lookatwhatimade.net%2fwp-content%2fuploads%2f2014%2f07%2fCrochet-Cable-Stitch-Dishcloth-2.jpg&ehk=j2H%2f3Vp8CTnLJwvzbGkRF5KOoGKZKChwo865FB3fNi0%3d&risl=&pid=ImgRaw&r=0')"}}>
                    <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                        <div class="px-10 max-w-xl">
            ...
            <div class="mt-12">
                ...
                <div class="grid gap-9 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 mt-6">
